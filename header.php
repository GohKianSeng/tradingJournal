  ...
  <body class="nav-md footer_fixed">
    <div class="container body">
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>Trading Journal</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
				...
				<h3>Trades</h3>
				  <li><a href="main_premarket.php"><i class="fa fa-newspaper-o"></i> Add Pre-Market</a></li>
                ...
                <h3>Trade Dictionary</h3>
				  <li><a href="main_strategy.php"><i class="fa fa-cubes"></i> View Strategies</a></li>
				  <li><a href="NewStrategy.php"><i class="fa fa-cube"></i> Add Strategies</a></li>
				  <li><a href="main_lessonlearn.php"><i class="fa fa-files-o"></i> View Lesson Learn</a></li>
        ...
        <div class="right_col" role="main" id="mainRightCol">
			<div class="">           
				<!-- page content -->